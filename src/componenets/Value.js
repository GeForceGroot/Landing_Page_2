                        ...
                        <div className="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="linear">
                            <div className="service11-boxarea text-center">
                                ...
                                <div className="service11-boxtext service12box text-center">
                                    ...
                                    <p className="font-16 font-outfit weight-400 colorhp12 margin-b24 ts">Our business model revolves around our clients, and our decisions are made for their comfort. The team is been allocated, and they are not allowed to work on other projects for quality.</p>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-right" data-aos-duration="600" data-aos-easing="linear">
                            <div className="service11-boxarea text-center">
                                ...
                                <div className="service11-boxtext service12box text-center">
                                    ...
                                    <p className="font-16 font-outfit weight-400 colorhp12 margin-b24 ts">Our employee diversity from various locations and industries brings in creativity and unique solutions at the least cost for customisation.</p>
                                </div>
                                <div className="service-vectorarea servicevector ts">
                                    <img src={svg} alt="" className="ts" />
                                </div>
